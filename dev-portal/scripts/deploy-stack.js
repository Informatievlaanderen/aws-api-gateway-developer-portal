...
const cognitoCertArn = deployerConfig.cognitoCertArn || ''
const customDomainName = deployerConfig.customDomainName || ''
const customDomainName2 = deployerConfig.customDomainName2 || ''
const customDomainCertArn = deployerConfig.customDomainCertArn || ''
  ...
  Promise.resolve()
      .then(() => execute(`
        sam package 
          ...
          --s3-bucket ${buildAssetsBucket} ${profileOption}`, true))
      .then(() => execute(`
        sam deploy 
          ...
          StaticAssetRebuildMode="${staticAssetRebuildMode}" 
          ...
          CognitoDomainAcmCertArn="${cognitoCertArn}" 
          CustomDomainName="${customDomainName}" 
          CustomDomainName2="${customDomainName2}" 
          CustomDomainNameAcmCertArn="${customDomainCertArn}" 
